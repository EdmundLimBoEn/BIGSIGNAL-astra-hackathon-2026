...
export function DisasterLab({
  ...
  function send() {
    try {
      ...
      setError("");
      setNotice(
        "Network tested in both directions. Inspect the weakest route below.",
      );
    } catch (e) {
  ...
  return (
    ...
    >
      ...
      <div
        className="dl-scenarios"
        role="group"
        aria-label="Disaster scenarios"
      >
        {disasters.map((d, i) => (
          <button
            className="dl-scenario"
            key={d.id}
            aria-pressed={state.preset === d.id}
            onClick={() => choosePreset(d.id as DisasterPresetId)}
          >
            <span>EXERCISE 0{i + 1}</span>
      ...
      <div className="dl-layout">
        <div>
          ...
          <div className="dl-actionbar">
            <button className="dl-send" onClick={send}>
              SEND IT · TEST NETWORK ↗
            </button>
            <p>
              {stale
            ...
            <div className="dl-panel-body">
              ...
              <details className="dl-details">
                ...
                <p className="dl-muted">
                  ...
                  traffic uses its battery too. Increase its entered duty cycle
                  to represent forwarding.
                </p>
              </details>
              <button
            ...
            <div className="dl-panel dl-section-gap">
              ...
              <div className="dl-panel-body">
                ...
                <Field
                  ...
                  onChange={(v) =>
                    edit((n) => {
                      n.links.find((l) => l.id === activeLink.id)!.frequencyHz =
                        v * 1e6;
                    })
                  }
                />
                      ...
                      <Field
                        ...
                        onChange={(v) =>
                          edit((n) => {
                            ...
                            if (env.model === "vhf-terrain" && env.obstruction)
                ...
                {onOpenLab && (
                  <button
                    onClick={() => onOpenLab(linkScenario(network, activeLink))}
                  >
