    ...
    <>
            ...
            <div className="surface fantasy-controls">
              ...
              {physics.mode === "fantasy" ? (
                <>
                  ...
                  <p>
                    Change a law, then compare with the real universe. Numerical
                    results are fictional under these assumptions.
                  </p>
                  {(
                    [
                    ...
                    <label className="check" key={key}>
                      <input
                        ...
                        checked={physics[key]}
                        onChange={(e) =>
                          onPhysics?.({ ...physics, [key]: e.target.checked })
                        }
                      />
                      {
                        {
                ...
                <p>
                  Ridiculous equipment, ordinary physical laws. Try 100 MW or a
                  kilometre-tall tower. Far-field and propagation assumptions
                  still have limits.
                </p>
              )}
            </div>
          ...
          <div className="lab-toolbar">
            {fresnel && (
              <p className="fresnel-caption">
                ...
                Radius comes from the engine; terrain heights and zone width are
                exaggerated together.
              </p>
            )}
            <button
              disabled={!result}
              onClick={() => {
                if (result)
                  setBaseline({
                    ...
                    result,
                    physics: structuredClone(extreme ? physics : REAL_PHYSICS),
                  });
              }}
            >
            ...
            <section className="comparison surface">
                  ...
                  <tbody>
                    {(
                      ...
                      <tr key={key}>
                        ...
                        <td>
                          {(result[key] - baseline.result[key]).toFixed(1)} dB
                        </td>
                      </tr>
                    ))}
                    <tr>
              ...
              <button
                onClick={() => {
                  ...
                  if (extreme) onPhysics?.(structuredClone(baseline.physics));
                }}
              >
                Restore A
              </button>
          ...
          {!controls && (
            <>
              ...
              <fieldset>
                ...
                <p>
                  Endpoints stay fixed. The model and mode change with the band.
                </p>
      ...
      {(!controls ||
        ...
        <section className="instrument-section">
          ...
          >
            {instruments ? "−" : "+"} Antenna & receiver workbench{" "}
            <small>
              Patterns · wire geometry · SWR · cable · receiver gain
            </small>
          </button>
          {instruments && <AdvancedLab scenario={scenario} onChange={edit} />}
        </section>
      )}
    </>
  );
